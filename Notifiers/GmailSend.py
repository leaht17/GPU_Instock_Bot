#Running this will just send a test email to our own email (gpuinstockbot@gmail.com)
#Not configured as an object yet
#Just for testing**
#Cleaned up formatting, may have issues coming from jupyter
